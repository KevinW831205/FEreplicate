...
public class OwnUnit extends FECharacter implements OwnTarget {
    public OwnUnit(String name, CharacterClass characterClass, Stats stats, Inventory inventory, WeaponSkillLevel weaponSkillLevel, Gender gender) {
